...
public class CreatePatientJsonValidation {
    ...
    private boolean validateHospitalVisitReason() {
    ...
    private boolean validateLastVisitDate() {
    ...
    private boolean validateUtiVisitCount() {
    ...
    private boolean validateDiabetic() {
    ...
    private boolean validateCatheterUsage() {
